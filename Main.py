# main.py
from actualizacion import act_datos,buscar_hoja_vida
from GestionHojaVida import add_cv
from GenerarR import (reporte_experiencia,
...
def menu_reportes():
    while True:
        ...
        if opcion == "1":
            años = int(input("Ingrese el mínimo de años de experiencia: "))
            reporte_experiencia(hojas_vida, años)
